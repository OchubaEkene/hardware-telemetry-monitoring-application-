...
export default function DashboardScreen() {
  ...
  const { connectionStatus, agentHost } = useHardware();
      ...
      >
        ...
        {connectionStatus === 'connected' && (
          <View style={[styles.banner, styles.bannerConnected]}>
            <Text style={styles.bannerText}>● Connected to {agentHost}</Text>
          </View>
        )}
        {connectionStatus === 'connecting' && (
          <View style={[styles.banner, styles.bannerConnecting]}>
            <Text style={styles.bannerText}>● Connecting...</Text>
          </View>
        )}
        {connectionStatus === 'error' && (
          <View style={[styles.banner, styles.bannerError]}>
            <Text style={styles.bannerText}>● Connection error — retrying</Text>
          </View>
        )}
        {connectionStatus === 'disconnected' && (
          <View style={[styles.banner, styles.bannerDisconnected]}>
            ...
            <Text
              style={[styles.bannerText, styles.bannerLink]}
...
const styles = StyleSheet.create({
  ...
  bannerConnected: { backgroundColor: 'rgba(16,185,129,0.15)' },
  bannerConnecting: { backgroundColor: 'rgba(245,158,11,0.15)' },
  bannerError: { backgroundColor: 'rgba(239,68,68,0.15)' },
  bannerDisconnected: { backgroundColor: 'rgba(100,116,139,0.15)' },
  bannerText: { fontSize: 12, color: '#94a3b8', fontWeight: '600' },
  bannerLink: { color: '#6366f1', textDecorationLine: 'underline' },
  actionButtons: {
    gap: 12,
    marginBottom: 24,
  },
