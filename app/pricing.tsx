  ...
  const upgradeContent = (
    <View style={styles.contentContainer}>
      ...
      <View style={styles.heroSection}>
        ...
        <Text style={styles.title}>Elevate Your Hardware Monitoring</Text>

        <Text style={styles.subtitle}>
          Unlock AI-powered insights, advanced analytics, and premium features
          to transform your hardware monitoring experience
        </Text>
      </View>
      ...
      <View style={styles.featuresSection}>
        ...
        <Text style={styles.featuresSubtitle}>
          Premium features designed to enhance your hardware monitoring
        </Text>
          ...
          {[
            {
              ...
              description: "Get intelligent insights from your hardware data",
            },
            {
              icon: "📊",
              title: "Advanced Analytics",
              description: "Track patterns and trends in your hardware performance",
            },
            {
              icon: "🔒",
